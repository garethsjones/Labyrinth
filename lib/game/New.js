...
module.exports = function(greenPlayerType, bluePlayerType, redPlayerType, yellowPlayerType) {
    ...
    if (greenPlayerType.humanity != 'None') players[1] = player1;
    if (bluePlayerType.humanity != 'None') players[2] = player2;
    if (redPlayerType.humanity != 'None') players[3] = player3;
    if (yellowPlayerType.humanity != 'None') players[4] = player4;
